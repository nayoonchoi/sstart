 <footer>
          ...
          <div class="utilMenu">
            <div class="container">
              <div>
              <p class="home"><a href="/HI_ART/index.php">홈</a></p>
              <p><a href="/HI_ART/view/manage/info.php">회사소개</p>
              <p><a href="/member/agreement.html">이용약관</a></p>
              <p><a href="/member/privacy.html"><strong>개인정보처리방침</strong></a></p>
              <p><a href="/HI_ART/view/manage/howto.php">이용안내</a></p><br />
            </div>
            </div>
          </div>
          <div >
              ...
              <span>HI ART는 통신판매 시스템을 제공하지 않으며, 통신판매의 당사자가 아니며 상품의 주문,배송 및 환불등과 관련한 의무와 책임은 각 판매자에게 있습니다.</br>
                <strong><a href="mailto:{$email}">대표자 이메일 주소: glglwjswls3@naver.com</a></strong> for more information.</span>
              </p>
          </div>
