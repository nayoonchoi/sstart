<h4>Hongik Artplatform</h4>
      ...
      <ul class="nav nav-pills flex-column" style="font-weight:bolder;">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/HI_ART/view/manage/howto.php"style="color:#282f3a;">이용 방법</a>
        </li>
        <li class="nav-item">
        ...
        <?php if(!isset($_SESSION['member_username']) || !isset($_SESSION['member_name'])) { ?>
         <li class="nav-item">
            <a class="nav-link" href="/HI_ART/view/manage/denial_access.php"style="color:#282f3a;">상품 의뢰</a>
         </li>
       <?php } else { ?>
          <li class="nav-item">
            <a class="nav-link" href="/HI_ART/view/manage/request/index.php"style="color:#282f3a;">상품 의뢰</a>
          </li>
