...
<tr>
  <td height="30" align="center" valign="middle" colspan="50" style="border:1px #CCCCCC solid;">
     ...
     $total_page = ceil($buyTotalCount/$list); //총 페이지 수 if ($b_end_page > $total_page)
         ...
         for($j = $b_start_page; $j <=$b_end_page; $j++)
          {
            ...
            }else{?> <font size=2><a href="/yw/buypaging.php?year=<?=$year?>&month=<?=$month?>&day=<?=$day?>&page=<?=$j?>&list=<?=$list?>"><?=$j?></a></font>
          <? }
        	}
