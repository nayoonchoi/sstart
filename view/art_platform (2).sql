...
CREATE TABLE `artwork` (
  ...
  `artwork_kinds` varchar(100) DEFAULT NULL,
  `artwork_materials` varchar(100) DEFAULT NULL,
  ...
  `artwork_image` varchar(300) DEFAULT NULL
...
(21, '꽃의나라', '기타', '오동나무', '2018-08-11', 80000, '0', '심오한 꽃의 세계를 표현했습니다.', '2018-08-06 20:44:14', '50cm*50cm', 1, 16, 'flowers.jpg'),
(22, '나비의죽음', '공예', '캔버스', '2018-07-10', 100000, '0', 'dd', '2018-08-07 15:19:05', '지름200cm', 1, 16, 'butterfly.jpg');
...
--
ALTER TABLE `artwork`
  MODIFY `artwork_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
