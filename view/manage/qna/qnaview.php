...
if(!empty($bNo) && empty($_COOKIE['qna' . $bNo])) {

		$sql = 'update qna set hit = hit + 1 where id = ' . $bNo;
		...
		if(empty($result)) {
			...
			setcookie('qna' . $bNo, TRUE, time() + (60 * 60 * 24), '/');

		}

	}

$sql = 'select id, title, description, author, created, hit from qna where id = ' . $bNo;
    ...
    <section class="content" >
      ...
      <?php require('../../../include/main_banner_left.php'); ?>
       ...
       <main>
         ...
         <span id="boardID">작성자: <?php echo $row['author']?></span>
         ...
         <div class="btnSet">
         				...
         				<a href="./qnawrite.php?bno=<?php echo $bNo?>">수정</a>

         				<a href="./qnadelete.php?bno=<?php echo $bNo?>">삭제</a>
