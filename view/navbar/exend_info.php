...
<div class="box">
               <ul class="nav nav-pills flex-column" style="font-weight:bolder; height:35px;">
                   <li class="nav-item" style="display:flex; align-items: center;">
                      <a class="nav-link " href="#"style="color:#282f3a;">종료된 전시 정보</a>
                <li>
                <ul>
            </div>
                  ...
                  <div >
                    ...
                    */
                    ...
                    $sql = "SELECT * FROM exhibition WHERE exhibit_edate < date(now()) LIMIT $s_point,$list";
                    $result=mysqli_query($conn,$sql);
              ...
              <div class="pagination">
                <?php
                                ...
                                ?>
                                    ...
                                    <a href="<?="http://localhost/HI_ART/view/navbar/exend_info.php"?>?page=<?=$p?>"><?=$p?></a>
