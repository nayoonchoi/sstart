...
<div>
  ...
  <input  class="form-control"type="text" name="name" required id="id_name" placeholder="Enter email"/>
</div>
<div>
  <label for="id_nickname">Nickname:</label>
  <input class="form-control" type="text" name="nickname" required id="id_nickname" placeholder="Enter email"/>
</div>
<div>
  <label for="id_phone">Phone:</label>
  <input  class="form-control"type="text" name="phone" required id="id_phone" placeholder="Enter email"/>
</div>
<div>
  <label for="id_stid">학번:</label>
  <input  class="form-control"type="text" name="stid" required id="id_stid" placeholder="Enter email"/>
</div>
<div>
